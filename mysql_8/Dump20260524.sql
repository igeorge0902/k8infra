CREATE DATABASE  IF NOT EXISTS `login_` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `login_`;
-- MySQL dump 10.13  Distrib 8.0.46, for macos15 (arm64)
--
-- Host: localhost    Database: login_
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `deviceId_uuid` AFTER INSERT ON `devices` FOR EACH ROW BEGIN
...
CREATE TABLE `events` (
  ...
  `screeningId` varchar(255) DEFAULT NULL,
  `screeningDatesId` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `events` VALUES (1,'Schindler\'s List','2026-05-26 14:00:00','Puskin Mozi','T403','273'),(2,'Schindler\'s List','2026-05-26 14:00:00','Uránia Filmszínház','T404','274');
/*!40000 ALTER TABLE `events` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `events_states`
--

DROP TABLE IF EXISTS `events_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `events_states` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_EVENTS_STATES_ON_EVENTS` (`events_id`),
  KEY `FK_EVENTS_STATES_ON_LOGINS` (`logins_id`),
  CONSTRAINT `FK_EVENTS_STATES_ON_EVENTS` FOREIGN KEY (`events_id`) REFERENCES `events` (`id`),
  CONSTRAINT `FK_EVENTS_STATES_ON_LOGINS` FOREIGN KEY (`logins_id`) REFERENCES `logins` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `events_states`
--

LOCK TABLES `events_states` WRITE;
/*!40000 ALTER TABLE `events_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `events_states` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `forgotPsw_BEFORE_INSERT` BEFORE INSERT ON `forgotpsw` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `forgotPsw_BEFORE_UPDATE` BEFORE UPDATE ON `forgotpsw` FOR EACH ROW BEGIN
    SET NEW.forgotRequestToken = RAND();
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tokens` AFTER INSERT ON `last_seen` FOR EACH ROW BEGIN
    DECLARE deviceId_ char(255);
    DECLARE id_ char(255);
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Last_seen_AFTER_UPDATE` AFTER UPDATE ON `last_seen` FOR EACH ROW BEGIN
    DECLARE deviceId_ char(255);
    SELECT deviceId INTO deviceId_ FROM Last_seen WHERE last_insert_id() = last_insert_id() ORDER BY Session_ DESC LIMIT 1;
    UPDATE Tokens SET Tokens.deviceId = deviceId_ WHERE Tokens.deviceId = deviceId_;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `logins` VALUES (2,'52fa80662e64c128f8389c9ea6c73d4c02368004bf4463491900d11aaadca39d47de1b01361f207c512cfa79f0f92c3395c67ff7928e3f5ce3e3c852b392f976','GI','97c6fd76-ed90-11e9-871a-874ce8a992e2','ildiko.gaspar.911@gmail.com','2019-10-13 08:09:41',NULL),(5,'52fa80662e64c128f8389c9ea6c73d4c02368004bf4463491900d11aaadca39d47de1b01361f207c512cfa79f0f92c3395c67ff7928e3f5ce3e3c852b392f976','Milo','f73b72c4-1071-11ea-9359-551258859352','igeorge1982@yahoo.com','2019-11-26 17:27:05',NULL),(9,'318672fb86ed60eb2a230a782d53f93c243d199f6f6972fee17a0ce8591ec803f0abf83335b2777b1c44792f98cf66567109c843a1c0deaa2a26b85825ca5ee7','GG','65f63602-6ddf-11e5-8441-71caa0c5f788','igeorge1982@gmail.com','2021-05-03 16:46:24',NULL),(10,'52fa80662e64c128f8389c9ea6c73d4c02368004bf4463491900d11aaadca39d47de1b01361f207c512cfa79f0f92c3395c67ff7928e3f5ce3e3c852b392f976','Georgie','a169e3e2-a8cb-11ea-8911-07c8d9e7f826','igeorge0902@hotmail.com','2020-09-24 14:39:01',NULL),(11,'52fa80662e64c128f8389c9ea6c73d4c02368004bf4463491900d11aaadca39d47de1b01361f207c512cfa79f0f92c3395c67ff7928e3f5ce3e3c852b392f976','Lilla','d686f5da-fe73-11ea-9233-14886e8c76ac','igeorge1982@hotmail.com','2020-09-24 14:40:06',NULL),(14,'52fa80662e64c128f8389c9ea6c73d4c02368004bf4463491900d11aaadca39d47de1b01361f207c512cfa79f0f92c3395c67ff7928e3f5ce3e3c852b392f976','Elle','c81e3d44-40d8-11f1-a49a-9abc55cdc2c6','ez@gmail.com','2026-04-25 18:58:43',NULL);
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `insert_guid` BEFORE INSERT ON `logins` FOR EACH ROW BEGIN
    SET NEW.uuid = UUID();
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `vouchers_trigger` AFTER INSERT ON `logins` FOR EACH ROW BEGIN
    DECLARE uuid_ char(255);
    SELECT uuid INTO uuid_ FROM logins WHERE last_insert_id() = last_insert_id() ORDER BY ID DESC LIMIT 1;
    INSERT INTO vouchers (uuid) VALUES (uuid_);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
CREATE TABLE `news_settings` (
  `id` int NOT NULL AUTO_INCREMENT,
  `newsScreening` varchar(255) DEFAULT NULL,
  `logins_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_NEWS_SETTINGS_ON_LOGINS` (`logins_id`),
  CONSTRAINT `FK_NEWS_SETTINGS_ON_LOGINS` FOREIGN KEY (`logins_id`) REFERENCES `logins` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `news_settings` WRITE;
/*!40000 ALTER TABLE `news_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `news_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Tokens_BEFORE_INSERT` BEFORE INSERT ON `tokens` FOR EACH ROW BEGIN
    SET NEW.token1 = UUID();
    SET NEW.token2 = RAND();
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Tokens_BEFORE_UPDATE` BEFORE UPDATE ON `tokens` FOR EACH ROW BEGIN
    SET NEW.token1 = UUID();
    SET NEW.token2 = RAND();
END */;;
DELIMITER ;
...
INSERT INTO `voucher_states` VALUES (8,'registered','12345',NULL,0,1,'2020-06-07 14:31:52','0.5890404531630132'),(9,'registered','12346',NULL,0,1,'2019-10-13 08:08:08','0.21622941476873067'),(10,'free','12347',NULL,0,0,'2026-04-25 15:31:05',''),(11,'registered','12348',NULL,0,1,'2019-12-14 17:34:51','0.1513986430609586'),(12,'registered','12349',NULL,0,1,'2026-04-25 15:22:23',NULL),(13,'free','12350',NULL,0,0,'2026-04-25 15:31:05',NULL),(14,'free','12351',NULL,0,0,'2026-04-25 15:31:05',NULL),(15,'registered','12352',NULL,1,0,'2019-11-26 17:27:05','0.3084171948101532'),(16,'registered','12353',NULL,0,1,'2020-12-18 12:10:02','0.955926410812816'),(17,'registered','12354',NULL,1,0,'2026-04-25 18:58:43','0.8110498095034154'),(18,'free','12355',NULL,1,0,'2019-03-05 00:04:28',''),(19,'free','12356',NULL,1,0,'2019-03-05 00:04:28',''),(20,'free','12357',NULL,0,0,'2026-04-25 15:31:05',NULL);
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `insert_voucher` BEFORE INSERT ON `vouchers` FOR EACH ROW BEGIN
...
--
-- Dumping events for database 'login_'
--

--
-- Dumping routines for database 'login_'
--
...
-- Dump completed on 2026-05-24 12:56:11
